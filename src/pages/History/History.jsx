      ...
      {status ? (
        ...
        <section>
          <section className='delete-all-history flex justify-between m-t-8'>
            ...
            <button
              onClick={(_) => dispatch(historyRemoveAll())}
          ...
          <section className='item-container grid gap-16'>
            {historyData.map((historyVideo) => (
              <div key={historyVideo._id} className='relative'>
                ...
                <button
                  onClick={(_) => dispatch(historyRemove(historyVideo._id))}
        ...
        <div className='flex-center flex-column m-16'>
          <h3 className='page-status text-align m-tb-8'>
            This list have no videos
          </h3>
        </div>
      )}
    </>
