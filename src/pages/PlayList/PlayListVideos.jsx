...
export const PlayListVideos = () => {
  ...
  console.log({ playListVideo, playlistId })
    ...
    <>
      {playListVideo?.videos?.length > 0 ? (
          ...
          {playListVideo.videos.map((video) => (
            <section className='c-pointer' key={video._id}>
              <div className='relative'>
                ...
                <button
                  onClick={(_) => deleteHandler(playListVideo._id, video._id)}
        ...
        <div className='flex-center flex-column m-16'>
          <h2 className='page-status text-align mr-16'>
            There is no videos in this playlist yet
          </h2>
        </div>
      )}
    </>
